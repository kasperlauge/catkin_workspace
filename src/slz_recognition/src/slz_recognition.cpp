...
bool recognize_slz(slz_recognition::ImageInfo::Request &req, slz_recognition::ImageInfo::Response &res) {
...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle nh;
    ros::ServiceServer service = nh.advertiseService("find_slz", recognize_slz);
